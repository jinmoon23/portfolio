...
export const cardData: CardData[] = [
  {
    ...
    text: 'text-white',
    techStack: ['React-native', 'Expo', 'FrameProcessor', 'TensorFlow Lite'],
    projectContent: {
  ...
  },
  {
    ...
    text: 'text-white',
    techStack: ['Next.js', 'React-native', 'React Query', 'Zustand'],
    projectContent: {
  ...
  },
  {
    ...
    text: 'text-white',
    techStack: ['React', 'TypeScript', 'Redux', 'TensorFlow'],
    projectContent: {
