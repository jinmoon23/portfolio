...
const ProjectContent: React.FC<ProjectContentProps> = ({
  ...
  const {
    ...
    projectBackground: backgroundContent,
  } = getProjectData();
      ...
      <div className='relative min-h-[800px] sm:min-h-[800px]'>
        {currentSlider === 'default' ? (
          <>
            {/* 프로젝트 기획 배경 섹션 */}
            <div
              className={`transform transition-all duration-700 delay-300 mb-8 ${
                isVisible
                  ? 'translate-x-0 opacity-100'
                  : '-translate-x-8 opacity-0'
              }`}
            >
              <div className='relative p-6 rounded-2xl bg-gradient-to-br from-rose-50/80 to-pink-100/60 dark:from-rose-900/20 dark:to-pink-900/20 backdrop-blur-sm border border-rose-200/50 dark:border-rose-700/30 shadow-lg hover:shadow-xl transition-shadow duration-300'>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='mb-4'>
                    ...
                    <div
                      className={`flex items-start gap-3 p-3 rounded-lg bg-white/60 dark:bg-gray-800/30 border border-rose-100 dark:border-rose-800/30 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-md ${
                        isVisible
                          ? 'translate-x-0 opacity-100'
                    ...
                    >
                      <div className='w-2 h-2 rounded-full bg-gradient-to-r from-rose-500 to-pink-500 mt-2 flex-shrink-0'></div>
                      <span className='text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed'>
                        {backgroundContent.question}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className='mb-4'>
                    ...
                    <div
                      className={`flex items-start gap-3 p-3 rounded-lg bg-rose-50/80 dark:bg-gray-800/30 border border-rose-200/50 dark:border-rose-800/30 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-md ${
                        isVisible
                          ? 'translate-x-0 opacity-100'
                          : 'translate-x-4 opacity-0'
                      }`}
                    ...
                    >
                      ...
                      <div className='space-y-2'>
                        <span className='text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed'>
                          {backgroundContent.existingProblems.description}
                        </span>
                        <ul className='list-disc list-inside space-y-1 ml-4'>
                          {backgroundContent.existingProblems.issues.map(
                            (issue, index) => (
                              <li
                                key={index}
                  ...
                  <div>
                    ...
                    <div
                      className={`flex items-start gap-3 p-3 rounded-lg bg-pink-50/80 dark:bg-gray-800/30 border border-pink-200/50 dark:border-rose-800/30 transform transition-all duration-500 hover:scale-[1.02] hover:shadow-md ${
                        isVisible
                          ? 'translate-x-0 opacity-100'
                          : 'translate-x-4 opacity-0'
                      }`}
                    ...
                    >
                      ...
                      <div className='space-y-2'>
                        <span className='text-sm sm:text-base text-gray-700 dark:text-gray-300 leading-relaxed'>
                          {backgroundContent.solutions.conclusion}
                        </span>
                        <ul className='list-disc list-inside space-y-1 ml-4'>
                          {backgroundContent.solutions.solution.map(
                            (issue, index) => (
                              <li
                                key={index}
                                className='text-sm sm:text-base text-gray-600 dark:text-gray-400'
